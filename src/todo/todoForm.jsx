    ...
    <form className='' onSubmit={props.handleAdd}>
        ...
        <div className='baixo'>
            <div className='teste'>
                ...
                <input className='data' type='date' value={props.date} onChange={props.handleChangeD} />
            </div>
            <div>
                <i className='fa fa-exclamation-circle'></i>
                <select required className='prioridade' value={props.prioridade} onChange={props.handleChangeP}>
            ...
            <input className='projeto teste' placeholder='Projeto' value='Projeto' />
